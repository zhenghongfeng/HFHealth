...
/**  */
@property (nonatomic, strong) HFHomeArticleListView *mainView;
@property (nonatomic, strong) HFHomeArticleListViewModel *viewModel;
...
- (HFHomeArticleListView *)mainView {
    
    if (!_mainView) {
        
        _mainView = [[HFHomeArticleListView alloc] initWithViewModel:self.viewModel];
    }
